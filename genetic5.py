...
class Population(object):
    ...
    def crossover(self, parent1, parent2):
        """
        2つの親個体から新しい子個体を生成する一点交差操作
        """
        crossover_point = random.randint(1, len(parent1.default_prob) - 1)  # 1から4の間で交差点を選択
        child_prob = []

        # 一点交差を適用
        child_prob.extend(parent1.default_prob[:crossover_point])  # 交差点まで親1を継承
        child_prob.extend(parent2.default_prob[crossover_point:])  # 交差点以降を親2を継承
